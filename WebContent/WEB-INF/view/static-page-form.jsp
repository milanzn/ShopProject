          ...
          <div class="col-md-6">
			...
			<form:form role="form" action="static-page-save" modelAttribute="staticPage">
                ...
                <div class="card-footer">
                 ...
                 <c:choose>
                <c:when test="${staticPage.contentType==1}">
                  <a href="${pageContext.request.contextPath}/about-us" <button class="btn btn-primary" target="_blank">About us page</button>></a>
                </c:when>
                <c:otherwise>
                 <a href="${pageContext.request.contextPath}/location" <button class="btn btn-primary" target="_blank">Location page</button>></a>
